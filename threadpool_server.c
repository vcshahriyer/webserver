...

	{
		...
		//declaring pointer type structure variable
		 threadpool tp;
        	 tp = create_threadpool(15);            // declaring pool number
		...
		p->hit=hit;
         ...
         dispatch(tp, (void *) web, (void *) p);  // tp is pointer type structure variable
